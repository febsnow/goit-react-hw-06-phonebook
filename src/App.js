...
class App extends Component {
  ...
  componentDidUpdate(prevState) {
    if (this.state.contacts !== prevState.contacts && this.state.contacts.length > 0) {
      localStorage.setItem("contacts", JSON.stringify(this.state.contacts));
    }
  }
  ...
  render() {
    ...
    return (
      <>
        ...
        <CSSTransition appear={true} in={error !== null} timeout={300} classNames={errorMsg} unmountOnExit>
